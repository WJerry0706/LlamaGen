...
def main(args):
    ...
    # Use the new --output-dir argument for the main results folder
    ...
    for class_id in range(args.num_classes):
        ...
        # Create class-specific subdirectories inside the main output folder
        out_dir = f"{args.output_dir}/class{class_id}"
        ...
        while remaining > 0:
            ...
            # class labels for the whole batch
            c_indices = torch.full((bs,), class_id, device=device, dtype=torch.long)

            t1 = time.time()
            # generate() is assumed to return a tuple; first element are indices [B, T]
            ...
            t2 = time.time()
            samples = vq_model.decode_code(index_sample, qzshape)  # [-1, 1], shape [bs, C, H, W]
    ...
    print(f"\nGeneration complete. All samples for this run are in '{args.output_dir}'.")
    # =========================================================================
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seed", type=int, default=0, help="Initial seed (unused per-image; batching uses random seeds per batch)")
    parser.add_argument("--top-k", type=int, default=2000, help="top-k value to sample with")
    parser.add_argument("--temperature", type=float, default=1.0, help="temperature value to sample with")
    parser.add_argument("--top-p", type=float, default=1.0, help="top-p value to sample with")

    parser.add_argument("--num-samples-per-class", type=int, default=10,
    ...
    parser.add_argument("--output-dir", type=str, default="output",
                        help="The root directory to save generated images")
