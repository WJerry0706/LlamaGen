...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", type=str, default='output_adjust', required=False)
    parser.add_argument("--code-path", type=str, default='extracted_output', required=False)
