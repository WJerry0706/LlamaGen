...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", type=str, default='/data/Work_dir/meissonic_output/temperature/llamagen_8', required=False)
    parser.add_argument("--code-path", type=str, default='llamagen_8', required=False)
